...
int js_rudp_sendto(int sock, struct sockaddr_in* clnt_addr, const void* msg_buf, size_t n, js_udp_struct udp_struct)//recv들어가 있는 부분에서 설계가 잘못됨. recv가 아닌 다른 bool값으로 대체할것.
{
	int i;
	char udp_buf[UDP_BUF_SIZE];
